# Dadas n funciones f1, f2, ..., fn y un entero positivo M, deseamos maximizar la función f1(n) + f2(n) + ... + fn(n) sujeta a la restricción n <= M,
#  donde fi(0) = 0 para i ∈ {1,...,n}, xi ∈ N, y todas las funciones son monótonamente crecientes, es decir, x > y ⇒ fi(x) > fi(y). 
# Los valores de cada función se almacenan en n vectores de M componentes
